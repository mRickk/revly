    ...
    <div class="row text-center">
        ...
        <div class="col-10">
            <form action="#" method="POST">
                ...
                <small class="mb-1">(All fields are required unless specified optional)</small>
                ...
                <input class="btn btn-primary mb-2 rounded-pill" type="submit" name="submit" value="CREATE ACCOUNT"/>
