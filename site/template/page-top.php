                ...
                <nav class="navbar bg-body-secondary bg-opacity-75 rounded-pill text-center shadow-sm">
                    ...
                    <div class="col-3">
                        <a class="nav-link active" href="notifications.php">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30%" fill="currentColor" class="bi bi-bell" viewBox="0 0 16 16">
                    ...
                    <div class="col-3">
                        <a class="nav-link active" href="create-post.php">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30%" fill="currentColor" class="bi bi-plus-square" viewBox="0 0 16 16">
