...
<article class="bg-body-secondary bg-opacity-75 mb-3 shadow">
    ...
    <div class="z-3 position-absolute start-50 translate-middle w-75 m-3">
        <div class="toast w-100" id="myToast" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="toast-body">
                Are you sure to delete this post?
                <div class="mt-2 pt-2 border-top">
                    <a href="deletePost.php?idPost=<?php echo $post['id_post'];?>">
        ...
        <div class="col-6">
            <div class="row gx-1">
                ...
                <?php for ($i = 0; $i < $post["evaluation"]; $i++): ?>
                    <div class="col-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="100%" fill="#F28380" class="bi bi-star-fill" viewBox="0 0 16 16">
                ...
                <?php for (; $i < 5; $i++): ?>
                    <div class="col-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="100%" fill="#6C757D" class="bi bi-star" viewBox="0 0 16 16">
